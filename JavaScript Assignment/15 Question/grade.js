...
switch(true){  //whatever is here return in the switch statement that should be matches with case statement also for eg: TRUE in SWITCH so there should be TRUE in the CASE statment also
